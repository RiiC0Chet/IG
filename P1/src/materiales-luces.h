...
#include <vector>
#include "ig-aux.h"
#include "practicas.h"  // para ContextoVis
...
class Material
{
   ...
   // activa un material en el cauce actual del contexto de visualización
   // (además, guarda el material en 'material_act' de dicho contexto)
